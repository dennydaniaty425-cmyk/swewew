...
@section('title', 'Edit Konten | Admin Dashboard')
    ...
    <main class="admin-container">
        <div class="admin-form-container">
            <div class="admin-form-header">
                <h1>Edit Konten</h1>
                <p>Perbarui data konten halaman website Apotek Alfa</p>
            </div>
            ...
            <div class="form-box">
                <form action="{{ route('admin.content.update', 1) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" rows="4" placeholder="Tulis deskripsi singkat untuk berita..." required>{{ old('description', $content->description ?? '') }}</textarea>
                        @error('description')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="carousel_count" name="carousel_count" value="{{ old('carousel_count', $content->carousel_count ?? 3) }}" min="1" max="10" placeholder="3">
