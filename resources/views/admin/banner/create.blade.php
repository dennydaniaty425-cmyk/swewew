...
@section('title', 'Tambah Banner | Admin Dashboard')
    ...
    <main class="admin-container">
        <div class="admin-form-container">
            <div class="admin-form-header">
                ...
                <p>Buat banner slideshow untuk ditampilkan di halaman utama</p>
            </div>
            ...
            <div class="form-box">
                <form action="{{ route('admin.banner.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title') }}" placeholder="Contoh: Layanan Utama Apotek" required>
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <small style="color: var(--apotek-muted); display: block; margin-top: 8px;">Pilih file gambar Anda, hasil upload akan tersimpan di folder storage/banner</small>
                        @error('image')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
