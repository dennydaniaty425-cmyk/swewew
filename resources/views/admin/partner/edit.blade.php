...
@section('title', 'Edit Logo Mitra | Admin Dashboard')
    ...
    <main class="admin-container">
        <div class="admin-form-container">
            <div class="admin-form-header">
                <h1>Edit Logo Principal</h1>
                <p>Ubah nama atau logo principal yang tampil di halaman Mitra Kami</p>
            </div>
            ...
            <div class="form-box">
                <form action="{{ route('admin.partner.update', $partner) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div id="logo-crop-wrapper" class="image-preview-wrapper crop-wrapper" style="display: none; margin-top: 12px;">
                            <div class="crop-container">
                                <img id="logo-crop-image" src="" alt="Atur crop logo baru">
                            </div>
                            <div class="crop-actions">
                                <button type="button" id="crop-reset" class="crop-btn">Reset Crop</button>
                                <span>Geser dan zoom foto, lalu perbarui.</span>
                            </div>
                        </div>
                        @error('logo')
                            <span class="error-message">{{ $message }}</span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="order" name="order" value="{{ old('order', $partner->order) }}" placeholder="0" min="0">
                        @error('order')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary">Perbarui Logo</button>
